...
Obj FuncDTP_Binomial(Obj self, Obj N, Obj K)
{
...
Obj FuncDTP_SequenceLetter(Obj self, Obj letter, Obj seq)
{
    if (!IS_PREC(letter))
...
Obj FuncDTP_Seq_i(Obj self, Obj letter, Obj i)
{
    if (!IS_PREC(letter))
...
Obj FuncDTP_AreAlmostEqual(Obj self, Obj letter1, Obj letter2)
{
    if (!IS_PREC(letter1))
